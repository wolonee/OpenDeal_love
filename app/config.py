DataUrl = "mongodb://expin1226707:.aRTTIG12267@91.107.123.97:37757/admin"
BOT_TOKEN = "6593951158:AAHZH0oRzhmdQ2yXrK9Lr4ijjF8csO41iOk"
WEBHOOK_PATH = "/webhook"
WEBHOOK_HOST = "https://a22380-6eb0.k.d-f.pw"
...
{% block conteiner_1 %}
  {% if last_list['TokenName'][0] %}
    ...
    <div class="conteiner_1" style="background-color: rgba(32, 178, 108, 0.4); box-shadow: 0px 0px 30px 30px rgba(32, 178, 108, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Take Profit!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% elif last_list['Fix_or_not'][0] == 0 %}
    <div class="conteiner_1" style="background-color: rgba(239, 69, 74, 0.4); box-shadow: 0px 0px 30px 30px rgba(239, 69, 74, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Stop Loss!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% else %}
    ...
    {% endif %}
      ...
      <div class="link_with_post">
        <a class="font_size_LEMON_MILK" style="color:#54d7f2;background: #a5d5ff1c;box-shadow: 0px 0px 15px 4px #a5d5ff24;" href="{{ last_list['Link_with_post'][0] }}">Post with this position</a>
      </div>
    </div>
  {% endif %}
{% endblock %}
...
{% block conteiner_2 %}
  ...
  <div class="conteiner-border"></div>
    {% if last_list['Fix_or_not'][1] == 1 %}
    <div class="conteiner_2" style="background-color: rgba(32, 178, 108, 0.4); box-shadow: 0px 0px 30px 30px rgba(32, 178, 108, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Take Profit!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% elif last_list['Fix_or_not'][1] == 0 %}
    <div class="conteiner_2" style="background-color: rgba(239, 69, 74, 0.4); box-shadow: 0px 0px 30px 30px rgba(239, 69, 74, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Stop Loss!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% else %}
    ...
    {% endif %}
          ...
          <div class="token_position_Leverage">
            <div class="token_and_position">
              ...
              {% if last_list['LongOrShort'][1] == "Long" %}
                <div class="font_LEMON_MILK_LongShort" style="background-color: #20b26c; color: #fff;"> {{ last_list['LongOrShort'][1] }} </div> 
              {% else %}
                <div class="font_LEMON_MILK_LongShort" style="background-color: #ef454a; color: #fff;"> {{ last_list['LongOrShort'][1] }} </div>
              {% endif %}     <!-- LONG or SHORT -->
            </div>
            <div class="Leverage">
      ...
      <div class="link_with_post">
        <a class="font_size_LEMON_MILK" style="color:#54d7f2;background: #a5d5ff1c;box-shadow: 0px 0px 15px 4px #a5d5ff24;" href="{{ last_list['Link_with_post'][1] }}">Post with this position</a>
      </div>
    </div>
  {% endif %}
{% endblock %}
...
{% block conteiner_3 %}
  ...
  <div class="conteiner-border"></div>
    {% if last_list['Fix_or_not'][2] == 1 %}
    <div class="conteiner_3" style="background-color: rgba(32, 178, 108, 0.4); box-shadow: 0px 0px 30px 30px rgba(32, 178, 108, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Take Profit!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% elif last_list['Fix_or_not'][2] == 0 %}
    <div class="conteiner_3" style="background-color: rgba(239, 69, 74, 0.4); box-shadow: 0px 0px 30px 30px rgba(239, 69, 74, 0.4);">
      <p class="font_LEMON_MILK" style="position: absolute; font-size: 4.5vw; left: 50%; transform: translate(-50%, -50%);">Stop Loss!</p>
      <div class="all_token_info" style="opacity: 0.4;">
    {% else %}
    ...
    {% endif %}
          ...
          <div class="token_position_Leverage">
            <div class="token_and_position">
              ...
              {% if last_list['LongOrShort'][2] == "Long" %}
                <div class="font_LEMON_MILK_LongShort" style="background-color: #20b26c; color: #fff;"> {{ last_list['LongOrShort'][2] }} </div> 
              {% else %}
                <div class="font_LEMON_MILK_LongShort" style="background-color: #ef454a; color: #fff;"> {{ last_list['LongOrShort'][2] }} </div>
              {% endif %}     <!-- LONG or SHORT -->
            </div>
            <div class="Leverage">
      ...
      <div class="link_with_post">
        <a class="font_size_LEMON_MILK" style="color:#54d7f2;background: #a5d5ff1c;box-shadow: 0px 0px 15px 4px #a5d5ff24;" href="{{ last_list['Link_with_post'][2] }}">Post with this position</a>
      </div>
    </div>
  {% endif %}
{% endblock %}
